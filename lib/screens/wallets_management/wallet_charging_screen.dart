...
class WalletsChargingScreen extends GetView<WalletsController> {
  const WalletsChargingScreen({Key? key}) : super(key: key);
        ...
        body: SafeArea(
          child: Row(
            ...
            children: [
              ...
              Expanded(
                flex: 5,
                child: CustomChargingWallet(controller: controller,),
              ),
            ],
          ),
        ),
